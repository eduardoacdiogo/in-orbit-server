...
ALTER TABLE "goal_completions" RENAME COLUMN "goals_id" TO "goal_id";--> statement-breakpoint
ALTER TABLE "goal_completions" DROP CONSTRAINT "goals_completions_goals_id_goals_id_fk";
